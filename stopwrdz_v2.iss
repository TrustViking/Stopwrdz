...
AllowNoIcons=yes
LicenseFile=D:\_scripts\Stopwrdz-main\dist\LICENSE.txt
InfoBeforeFile=D:\_scripts\Stopwrdz-main\dist\befor_install.txt
; Uncomment the following line to run in non administrative install mode (install for current user only.)
;PrivilegesRequired=lowest
PrivilegesRequired=lowest
OutputDir=D:\_scripts\Stopwrdz-main\dist\
OutputBaseFilename=stopwrdz_setup
SetupIconFile=D:\_scripts\Stopwrdz-main\dist\stopwrdz_.ico
Compression=lzma
...
[Files]
Source: "D:\_scripts\Stopwrdz-main\dist\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\_scripts\Stopwrdz-main\dist\config.json"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\_scripts\Stopwrdz-main\dist\stopwrdz_.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\_scripts\Stopwrdz-main\dist\vocabs\*"; DestDir: "{app}\vocabs"; Flags: ignoreversion recursesubdirs createallsubdirs
