...
AllowNoIcons=yes
LicenseFile=D:\_scripts\Stopwrdz-main\LICENSE.txt
InfoBeforeFile=D:\_scripts\Stopwrdz-main\befor_install.txt
; Uncomment the following line to run in non administrative install mode (install for current user only.)
;PrivilegesRequired=lowest
PrivilegesRequired=lowest
OutputDir=D:\_scripts\Stopwrdz-main\setup_install\
OutputBaseFilename=stopwrdz_v4_setup
SetupIconFile=D:\_scripts\Stopwrdz-main\stopwrdz_.ico
Compression=lzma
...
[Files]
Source: "D:\_scripts\Stopwrdz-main\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\_scripts\Stopwrdz-main\config.json"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\_scripts\Stopwrdz-main\stopwrdz_.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\_scripts\Stopwrdz-main\vocabs\*"; DestDir: "{app}\vocabs"; Flags: ignoreversion recursesubdirs createallsubdirs
